# Poem Display Optimization Tasks

- [x] Update createPoemCard function in client/js/poems.js to truncate at 29 words instead of 100
- [x] Extract poem text by removing the appended signature
